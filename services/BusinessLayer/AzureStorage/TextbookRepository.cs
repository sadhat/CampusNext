...
namespace CampusNext.Services.BusinessLayer.AzureStorage
{
    public class TextbookRepository : ITextbookRepository
    {
        ...
        private static void Seed()
        {
            ...
            //1
            var textbook1 = new TextbookEntity("NDSU")
            {
                Description =
            ...
            //2
            var textbook2 = new TextbookEntity("NDSU")
            {
                Description =
            ...
            //3
            var textbook3 = new TextbookEntity("NDSU")
            {
                Description =
            ...
            //4
            var textbook4 = new TextbookEntity("NDSU")
            {
                Description =
            ...
            //5
            var textbook5 = new TextbookEntity("NDSU")
            {
                Description =
